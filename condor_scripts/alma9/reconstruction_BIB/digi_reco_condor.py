...
# running this gives errors (faulty pointer in SelectedTracks container). Going to remove this for now, since it isn't used in reconstruction anyways.
...
# removing MyTrackSelector - see note above the algorithm definition
